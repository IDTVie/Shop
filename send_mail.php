...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // IMPORTANT: Ideally, change 'noreply@yoursite.com' to your actual domain (e.g., noreply@idtv-eire.com)
    // Using a domain that matches your hosting server prevents spam filtering.
    $email_headers = "From: IDTV Web Form <noreply@yoursite.com>\r\n";
